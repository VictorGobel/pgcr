...
export default function Question4() {
  ...
  const goToNextPage = () => {
    history.replace("/pgcr/question5");
  }
  ...
  return (
    <QuestionContainer>
      <Title>Quelle est la couleur de ta peau ?</Title>
      <AnswerContainer>
        <Answer onClick={goToErrorPage}>Orange</Answer>
        <Answer onClick={goToNextPage}>Blanche</Answer>
      </AnswerContainer>
    </QuestionContainer>
  );
}
