...
export default function Question3() {
  ...
  const goToNextPage = () => {
    history.replace("/pgcr/question4");
  }
  ...
  return (
    <QuestionContainer>
      <Title>Est ce que tu en es sûr ?</Title>
      <AnswerContainer>
        <Answer onClick={goToErrorPage}>Je ne sais pas</Answer>
        <Answer onClick={goToErrorPage}>Non</Answer>
        <Answer onClick={goToErrorPage}>J'ai oublié la question</Answer>
        <Answer onClick={goToNextPage}>Oui</Answer>
      </AnswerContainer>
    </QuestionContainer>
  );
}
